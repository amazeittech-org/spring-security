...
insert into users (username, password, enabled) values ('bharatiyas', '$2a$10$GZXqcWDKM/FBOtBK5kPnxOf/Onx1UcHlBiQzumLlloqMbZmpdgI4C', '1');
insert into users (username, password, enabled) values ('bharatiyai', '$2a$10$GZXqcWDKM/FBOtBK5kPnxOf/Onx1UcHlBiQzumLlloqMbZmpdgI4C', '1');
...
insert into group_members (id, username, group_id) values (1, 'bharatiyas', 1);
insert into group_members (id, username, group_id) values (2, 'bharatiyai', 2);
